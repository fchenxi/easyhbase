...
public final class HBaseTables {
    ...
    // applicationIndex
    public static final int APPLICATION_TRACE_INDEX_ROW_DISTRIBUTE_SIZE = 1; // applicationIndex
    // hash size
    ...
    @Deprecated
    public static final byte[] AGENT_STAT_CF_STATISTICS_MEMORY_GC = Bytes.toBytes("Gc"); //
    // qualifier for Heap Memory/Gc statistics
    @Deprecated
    public static final byte[] AGENT_STAT_CF_STATISTICS_CPU_LOAD = Bytes.toBytes("Cpu"); //
    // qualifier for CPU load statistics
    // FIXME (2016.06) Legacy column for storing stat data directly to columns
    @Deprecated
    public static final byte[] AGENT_STAT_COL_INTERVAL = Bytes.toBytes("int"); // qualifier for
    // collection interval
    @Deprecated
    public static final byte[] AGENT_STAT_COL_GC_TYPE = Bytes.toBytes("gcT"); // qualifier for GC
    // type
    @Deprecated
    public static final byte[] AGENT_STAT_COL_GC_OLD_COUNT = Bytes.toBytes("gcOldC"); //
    // qualifier for GC old count
    @Deprecated
    public static final byte[] AGENT_STAT_COL_GC_OLD_TIME = Bytes.toBytes("gcOldT"); // qualifier
    // for GC old time
    @Deprecated
    public static final byte[] AGENT_STAT_COL_HEAP_USED = Bytes.toBytes("hpU"); // gualifier for
    // heap used
    @Deprecated
    public static final byte[] AGENT_STAT_COL_HEAP_MAX = Bytes.toBytes("hpM"); // qualifier for
    // heap max
    @Deprecated
    public static final byte[] AGENT_STAT_COL_NON_HEAP_USED = Bytes.toBytes("nHpU"); // qualifier
    // for non-heap used
    @Deprecated
    public static final byte[] AGENT_STAT_COL_NON_HEAP_MAX = Bytes.toBytes("nHpM"); // qualifier
    // for non-heap max
    @Deprecated
    public static final byte[] AGENT_STAT_COL_JVM_CPU = Bytes.toBytes("jvmCpu"); // qualifier for
    // JVM CPU usage
    @Deprecated
    public static final byte[] AGENT_STAT_COL_SYS_CPU = Bytes.toBytes("sysCpu"); // qualifier for
    // system CPU usage
    @Deprecated
    public static final byte[] AGENT_STAT_COL_TRANSACTION_SAMPLED_NEW = Bytes.toBytes("tSN"); //
    // qualifier for sampled new count
    @Deprecated
    public static final byte[] AGENT_STAT_COL_TRANSACTION_SAMPLED_CONTINUATION = Bytes.toBytes
            ("tSC"); // qualifier for sampled continuation count
    @Deprecated
    public static final byte[] AGENT_STAT_COL_TRANSACTION_UNSAMPLED_NEW = Bytes.toBytes("tUnSN");
    // qualifier for unsampled new count
    @Deprecated
    public static final byte[] AGENT_STAT_COL_TRANSACTION_UNSAMPLED_CONTINUATION = Bytes.toBytes
            ("tUnSC"); // qualifier for unsampled continuation count
    @Deprecated
    public static final byte[] AGENT_STAT_COL_ACTIVE_TRACE_HISTOGRAM = Bytes.toBytes("aH"); //
    // qualifier for active trace histogram
    ...
    public static final byte[] AGENT_LIFECYCLE_CF_STATUS = Bytes.toBytes("S"); // agent lifecycle
    // column family
    public static final byte[] AGENT_LIFECYCLE_CF_STATUS_QUALI_STATES = Bytes.toBytes("states");
    // qualifier for agent lifecycle states

    public static final TableName AGENT_EVENT = TableName.valueOf("AgentEvent");
    public static final byte[] AGENT_EVENT_CF_EVENTS = Bytes.toBytes("E"); // agent events column
    // family

    @Deprecated
    public static final TableName AGENTID_APPLICATION_INDEX = TableName.valueOf
            ("AgentIdApplicationIndex");
    @Deprecated
    public static final byte[] AGENTID_APPLICATION_INDEX_CF_APPLICATION = Bytes.toBytes
            ("Application");
    ...
    public static final byte[] SQL_METADATA_VER2_CF_SQL_QUALI_SQLSTATEMENT = Bytes.toBytes
            ("P_sql_statement");
    ...
    public static final byte[] API_METADATA_CF_API_QUALI_SIGNATURE = Bytes.toBytes
            ("P_api_signature");

    public static final TableName MAP_STATISTICS_CALLER_VER2 = TableName.valueOf
            ("ApplicationMapStatisticsCaller_Ver2");
    public static final byte[] MAP_STATISTICS_CALLER_VER2_CF_COUNTER = Bytes.toBytes("C");

    public static final TableName MAP_STATISTICS_CALLEE_VER2 = TableName.valueOf
            ("ApplicationMapStatisticsCallee_Ver2");
    public static final byte[] MAP_STATISTICS_CALLEE_VER2_CF_COUNTER = Bytes.toBytes("C");

    public static final TableName MAP_STATISTICS_SELF_VER2 = TableName.valueOf
            ("ApplicationMapStatisticsSelf_Ver2");
    public static final byte[] MAP_STATISTICS_SELF_VER2_CF_COUNTER = Bytes.toBytes("C");

    public static final TableName HOST_APPLICATION_MAP_VER2 = TableName.valueOf
