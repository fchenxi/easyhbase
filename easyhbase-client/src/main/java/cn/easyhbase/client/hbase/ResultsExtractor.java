 ...
 * {@link ResultScanner} but  without having to worry about exception handling or resource
 * management.
 *
 * @author Costin Leau
 */
public interface ResultsExtractor<T> {
     ...
     *
     * @param results {@link ResultScanner} to extract data from. Implementations should not
     *                                     close this; it will be closed
     *                automatically by the calling {@link HbaseTemplate}
     * @return an arbitrary result object, or null if none (the extractor will typically be
