...
package cn.easyhbase.client.hbase.monitor;
 ...
 * https://github.com/dropwizard/metrics/blob/3.2-development/metrics-core/src/main/java/com
 * /codahale/metrics/InstrumentedExecutorService.java
 * <p>
 * Caution : If using multiple method (like invokeAny, invokeAll), then rejected count can be
 * incorrect.
 *
 * @author Taejin Koo
 */
public class MonitoredExecutorService implements ExecutorService {
    ...
    @Override
    public <T> List<Future<T>> invokeAll(Collection<? extends Callable<T>> callables, long
    ...
    private <T> Collection<? extends Callable<T>> instrument(Collection<? extends Callable<T>>
                                                                     callables) {
